...
ns=100:100:2000; % number of training samples (n_train in paper), use this line if you run for the main result
...
trainfile=['./',folder,'/','training_dataset_2k.mat']; % use this line if you run for the main result
