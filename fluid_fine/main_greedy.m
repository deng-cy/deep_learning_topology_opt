...
for i=1:iter
    ...
    cmdstr=sprintf('C:/Users/dcy60/Anaconda3/Scripts/activate & C:/Users/dcy60/Anaconda3/python.exe -c "import mlopt; mlopt.func(None,''%s'',''%s'',%d,%d,topk=%d,n=%d)" ', trainfile,optfile,seed_train,seed_opt,n,220000);
