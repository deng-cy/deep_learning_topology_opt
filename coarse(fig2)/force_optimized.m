...
% force_optimized.m
%
% Model exported on Feb 21 2020, 22:25 by COMSOL 5.4.0.225.
...
model.modelPath('C:\Users\dcy60\Google Drive\Research\MLOPT\code_data\coarse(fig2)');

model.label('force_optimized.mph');
...
model.param.set('L1', '0.25 [m]', 'support width');
...
model.component('comp1').func('int1').set('filename', 'inputfile.txt');
...
model.component('comp1').physics('opt').create('cvar1', 'ControlVariableField', 2);
model.component('comp1').physics('opt').feature('cvar1').set('fieldVariableName', 'pp');
model.component('comp1').physics('opt').feature('cvar1').selection.set([1]);
model.component('comp1').physics('opt').feature('cvar1').create('bound1', 'ControlVariableBounds', -1);
model.component('comp1').physics('opt').create('iconstr1', 'IntegralInequality', 2);
model.component('comp1').physics('opt').feature('iconstr1').selection.set([1]);
...
model.component('comp1').view('view1').axis.set('xmin', -1.4196717739105225);
model.component('comp1').view('view1').axis.set('xmax', 2.553375482559204);
model.component('comp1').view('view1').axis.set('ymin', -1.1356935501098633);
model.component('comp1').view('view1').axis.set('ymax', 1.1257814168930054);
...
model.component('comp1').physics('opt').feature('cvar1').set('initialValue', 'volfrac');
model.component('comp1').physics('opt').feature('cvar1').set('order', 1);
model.component('comp1').physics('opt').feature('cvar1').feature('bound1').set('upperBound', 1);
model.component('comp1').physics('opt').feature('iconstr1').set('constraintExpression', 'pp');
model.component('comp1').physics('opt').feature('iconstr1').set('upperBound', 'volfrac');
model.component('comp1').physics('opt').feature('iobj1').set('objectiveExpression', 'solid.Ws');
...
model.study('std1').feature('opt').set('gradientStep', 'stat');
model.study('std1').feature('opt').set('objtable', 'tbl4');

model.sol('sol1').attach('std1');
model.sol('sol1').feature('o1').set('control', 'opt');
model.sol('sol1').feature('o1').set('optsolver', 'mma');
...
model.result.numerical('int1').set('expr', {'solid.Ws' 'pp'});
model.result.numerical('int1').set('unit', {'J/m' 'm^2'});
model.result.numerical('int1').set('descr', {'Elastic strain energy density' 'Control variable pp'});
...
model.result('pg1').feature('surf1').set('descr', 'Control variable pp');
